...
function daisy_blog_register_recent_post_widget() {
    register_widget( 'Daisy_Blog_Recent_Post' );
}
add_action( 'widgets_init', 'daisy_blog_register_recent_post_widget' );
...
class Daisy_Blog_Recent_Post extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            __( 'Graphthemes: Recent Post', 'daisy-blog' ), // Name
            array( 'description' => __( 'A Recent Post Widget', 'daisy-blog' ), ) // Args
        );
    }
    ...
    public function widget( $args, $instance ) {
        $title      = ! empty( $instance['title'] ) ?  $instance['title'] : __( 'Recent Posts', 'daisy-blog' );
