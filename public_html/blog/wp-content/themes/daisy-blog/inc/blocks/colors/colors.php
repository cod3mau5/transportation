...
add_action( 'customize_register', 'daisy_blog_color_section' );
function daisy_blog_color_section( $wp_customize )
{
    $wp_customize->get_section( 'colors' )->title = esc_html__( "Color Options", 'daisy-blog' );
