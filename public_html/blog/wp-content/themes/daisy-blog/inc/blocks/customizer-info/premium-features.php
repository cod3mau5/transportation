...
add_action( 'customize_register', 'daisy_blog_customizer_premium_features' );

function daisy_blog_customizer_premium_features( $wp_customize ) {
    ...
    $premium_features = '<div class="premium-info"><h2>' . esc_html__( 'Premium Version', 'daisy-blog' ) . ': </h2>
	...
	<a class="button button-primary" href="' . esc_url( 'https://graphthemes.com/daisy-blog/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'daisy-blog' ) . '</a></div>';

	$wp_customize->add_control( new Daisy_Blog_Custom_Text( $wp_customize ,'premium_features',array(
