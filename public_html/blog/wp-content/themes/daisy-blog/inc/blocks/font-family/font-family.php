...
add_action( 'wp_enqueue_scripts', 'daisy_blog_google_fonts_scripts' );
function daisy_blog_google_fonts_scripts() {
    $args = daisy_blog_used_google_fonts();
    wp_enqueue_style( 'google-fonts', daisy_blog_fonts_url( $args ), array(), null );
}