...
add_action( 'customize_register', 'daisy_blog_register_general_customization_section' );
function daisy_blog_register_general_customization_section( $wp_customize ) {

	$wp_customize->add_section( 'daisy_blog_general_customization_section', array(
	    'title'	=> esc_html__( 'General Options', 'daisy-blog' ),
	    'priority'	=> 21
	) );
