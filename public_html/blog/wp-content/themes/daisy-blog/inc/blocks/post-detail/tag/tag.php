...
add_action( 'customize_register', 'daisy_blog_post_detail_tag' );
function daisy_blog_post_detail_tag( $wp_customize ) {

	$wp_customize->add_setting( 'post_detail_hide_show_tag', array(
        'sanitize_callback'     =>  'daisy_blog_sanitize_checkbox',
        'default'               =>  daisy_blog_get_default_post_detail_tag()
    ) );
