...
add_action( 'customize_register', 'daisy_blog_register_post_detail_customization_section' );
function daisy_blog_register_post_detail_customization_section( $wp_customize ) {

	$wp_customize->add_section( 'daisy_blog_post_detail_customization_section', array(
	    'title'	=> esc_html__( 'Post Detail', 'daisy-blog' ),
	    'priority'	=> 23
	) );
