<script type="text/javascript">
	var fb = '<?php echo esc_html__( "Facebook", 'daisy-blog' ); ?>';
	var twitter = '<?php echo esc_html__( "Twitter", 'daisy-blog' ); ?>';
	var pinterest = '<?php echo esc_html__( "Pinterest", 'daisy-blog' ); ?>';
	var linkedin = '<?php echo esc_html__( "Linkedin", 'daisy-blog' ); ?>';
</script>
...
<ul class="list-inline">
	...
	<li><?php esc_html_e( "Share", 'daisy-blog' ); ?>:</li>
