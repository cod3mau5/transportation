...
add_action( 'customize_register', 'daisy_blog_post_snippet_category' );
function daisy_blog_post_snippet_category( $wp_customize ) {

	$wp_customize->add_setting( 'post_snippet_hide_show_category', array(
        'sanitize_callback'     =>  'daisy_blog_sanitize_checkbox',
        'default'               =>  daisy_blog_get_default_post_snippet_category()
    ) );
