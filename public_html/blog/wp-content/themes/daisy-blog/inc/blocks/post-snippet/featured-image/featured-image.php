...
add_action( 'customize_register', 'daisy_blog_post_snippet_featured_image' );
function daisy_blog_post_snippet_featured_image( $wp_customize ) {

	$wp_customize->add_setting( 'post_snippet_hide_show_featured_image', array(
        'sanitize_callback'     =>  'daisy_blog_sanitize_checkbox',
        'default'               =>  daisy_blog_get_default_post_snippet_featured_image()
    ) );
...
add_action( 'customize_register', 'daisy_blog_post_snippet_featured_image_size' );
function daisy_blog_post_snippet_featured_image_size( $wp_customize ) {

    $wp_customize->add_setting( 'post_snippet_featured_image_size', array(
        'default'     => daisy_blog_get_default_post_snippet_featured_image_size(),
    ...
    $wp_customize->add_control( 'post_snippet_featured_image_size', array(
        ...
        'active_callback' => function(){
            return get_theme_mod( 'post_snippet_hide_show_featured_image', daisy_blog_get_default_post_snippet_featured_image() );
        },
        'choices'     => array(
