...
add_action( 'customize_register', 'daisy_blog_post_snippet_social_share' );
function daisy_blog_post_snippet_social_share( $wp_customize ) {

	$wp_customize->add_setting( 'post_snippet_hide_show_social_share', array(
        'sanitize_callback'     =>  'daisy_blog_sanitize_checkbox',
        'default'               =>  daisy_blog_get_default_post_snippet_social_share()
    ) );
...
add_action( 'customize_register', 'daisy_blog_post_snippet_social_share_options' );
function daisy_blog_post_snippet_social_share_options( $wp_customize ) {

    $wp_customize->add_setting( 'post_snippet_social_share_options', array(
        'sanitize_callback' => 'daisy_blog_sanitize_array',
        'default'     => daisy_blog_get_default_post_snippet_social_share_options()
    ) );
    ...
    $wp_customize->add_control( new Graphthemes_Multi_Check_Control( $wp_customize, 'post_snippet_social_share_options', array(
        ...
        'active_callback' => function() {
            return get_theme_mod( 'post_snippet_hide_show_social_share', daisy_blog_get_default_post_snippet_social_share() );
        }
    ) ) );
