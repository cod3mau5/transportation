   ...
   <div class="container">
       <div class="row">
           ...
           <div class="col-md-3">
                ...
                <nav class="footer-nav">
                    <ul class="s2-color">
                        <li><a href="/tour/Los-Cabos-City-Tour">Los Cabos City Tour</a></li>
                        <li><a href="/tour/Todos-Santos">Todos Santos City Tour</a></li>
                        <li><a href="/tour/La-Paz">La Paz City Tour</a></li>
                    </ul>
                </nav>
           </div>
           <div class="col-md-3">
