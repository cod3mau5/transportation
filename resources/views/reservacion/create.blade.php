...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title"><strong>CREAR RESERVACION</strong></h3>
    </div>
    <div class="box-body">
        <div id="agregar">
        ...
        $(document).ready(function() {
            ...
            function checkTipoServicio()
            {
                ...
                if (selected == 'roundtrip')
                {
                    ...
                    if (location_start == 0)
                    {
                        $('#departure_date').val('').removeAttr('required').prop('readonly', true);
                        $('#departure_flight').val('').removeAttr('required').prop('readonly', true);
                        $('#departure_time').val('').removeAttr('required').prop('readonly', true);
                        $('#departure_airline').val('').removeAttr('required').prop('readonly', true);
