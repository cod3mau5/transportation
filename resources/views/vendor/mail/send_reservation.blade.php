@component('mail::message')
    ...
    <b>Welcome to Los Cabos!</b> We are confident that you and your family will have a wonderful vacation experience. This voucher is your boarding pass for the Private that will transport you and your family to our resort. Our representative will be waiting for you outside the airport. <br> He will be holding a sign that says his name. And is the only person who knows your VOUCHER number <b>{{$reservation->voucher}}</b> Anyone else who does not have or know your VOUCHER number, they are not Staff from our Company.
    </p>
    <p style="text-align: center; color: #005899; font-size: 11.5px;">
